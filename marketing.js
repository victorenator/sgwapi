...
class NewsletterCategory {
  ...
  add(category, name) {
    _assert.default.ok(category, 'category is required');

    _assert.default.ok(name, 'name is required');

    return this.client.call('add', 'newsletter/category', {
      form: {
        category,
        name
      }
  ...
  create(category) {
    ...
    return this.client.call('create', 'newsletter/category', {
      form: {
        category
      }
    });
  ...
  list({
    ...
    return this.client.call('list', 'newsletter/category', {
      form: {
        category
      }
    });
  ...
  remove(name, {
    ...
    return this.client.call('remove', 'newsletter/category', {
      form
    });
  }
...
class NewsletterListsEmail {
  ...
  add(list, data) {
    _assert.default.ok(list, 'list is required');

    _assert.default.ok(data, 'data is required');

    return this.client.call('add', 'newsletter/lists/email', {
      form: {
        list,
  ...
  delete(list, email) {
    ...
    return this.client.call('delete', 'newsletter/lists/email', {
      form: {
        list,
        email
      }
  ...
  get(list, {
    ...
    return this.client.call('get', 'newsletter/lists/email', {
      form
    });
  }
...
class NewsletterLists {
  ...
  add(list, {
    ...
    return this.client.call('add', 'newsletter/lists', {
      form: {
        list,
        name,
        ...columns
  ...
  delete(list) {
    ...
    return this.client.call('delete', 'newsletter/lists', {
      form: {
        list
      }
    });
  ...
  edit(list, newlist) {
    ...
    _assert.default.ok(newlist, 'newlist is required');

    return this.client.call('edit', 'newsletter/lists', {
      form: {
        list,
        newlist
      }
  ...
  get(list) {
    return this.client.call('get', 'newsletter/lists', {
      form: list ? {
        list
      } : {}
    });
...
class NewsletterIdentity {
  ...
  add(identity, name, email, address, city, state, zip, country) {
    _assert.default.ok(identity, 'identity is required');

    _assert.default.ok(name, 'name is required');

    _assert.default.ok(email, 'email is required');

    _assert.default.ok(address, 'address is required');

    _assert.default.ok(city, 'city is required');

    _assert.default.ok(state, 'state is required');

    _assert.default.ok(zip, 'zip is required');

    _assert.default.ok(country, 'country is required');

    return this.client.call('add', 'newsletter/identity', {
      form: {
        identity,
        name,
        email,
  ...
  delete(identity) {
    ...
    return this.client.call('delete', 'newsletter/identity', {
      form: {
        identity
      }
    });
  ...
  edit(identity, {
    ...
    return this.client.call('edit', 'newsletter/identity', {
      form
    });
  }
  /**
  ...
  get(identity) {
    ...
    return this.client.call('get', 'newsletter/identity', {
      form: {
        identity
      }
    });
  ...
  list({
    ...
    return this.client.call('list', 'newsletter/identity', {
      form: identity ? {
        identity
      } : {}
    });
...
class NewsletterRecipients {
  ...
  add(name, list) {
    ...
    return this.client.call('add', 'newsletter/recipients', {
      form: {
        name,
        list
      }
  ...
  delete(name, list) {
    ...
    return this.client.call('delete', 'newsletter/recipients', {
      form: {
        name,
        list
      }
  ...
  get(name) {
    ...
    return this.client.call('get', 'newsletter/recipients', {
      form: {
        name
      }
    });
...
class NewsletterSchedule {
  ...
  add(name, {
    ...
    return this.client.call('add', 'newsletter/schedule', {
      form
    });
  }
  /**
  ...
  delete(name) {
    ...
    return this.client.call('delete', 'newsletter/schedule', {
      form: {
        name
      }
    });
  ...
  get(name) {
    ...
    return this.client.call('get', 'newsletter/schedule', {
      form: {
        name
      }
    });
...
class Marketing {
  ...
  add(identity, name, subject, text, html) {
    ...
    _assert.default.ok(text, 'text is required');

    _assert.default.ok(html, 'html is required');

    return this.client.call('add', 'newsletter', {
      form: {
        identity,
        name,
        subject,
  ...
  edit(identity, name, newname, subject, text, html) {
    ...
    return this.client.call('edit', 'newsletter', {
      form: {
        identity,
        name,
        newname,
  ...
  delete(name) {
    ...
    return this.client.call('delete', 'newsletter', {
      form: {
        name
      }
    });
  ...
  get(name) {
    ...
    return this.client.call('get', 'newsletter', {
      form: {
        name
      }
    });
  ...
  list({
    ...
    return this.client.call('list', 'newsletter', {
      form: name ? {
        name
      } : {}
    });
